...
public class ItemLootAction extends LocationAction {
  ...
  protected ItemLootAction(int id, StoryAction next, ExLocation location,
  ...
  public ItemLootAction(StoryBookBuilder bookBuilder, Quest quest, Toml action, int id,
        ...
        try {
          ...
          if (material != null) {
            ...
            throw new InvalidArgumentTypeException(
                "'" + name + "' is not a story item nor a material");
          }
        }
      }
    } else {
  ...
  public StoryAction clone(Quest quest, StoryReader reader, StoryAction clonedNext,
    ...
    return new ItemLootAction(this.id, clonedNext,
        ...
        this.storyItems.stream().map(i -> i.clone(this.reader)).collect(Collectors.toList()),
